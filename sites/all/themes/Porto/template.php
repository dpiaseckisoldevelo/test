...
function porto_preprocess_page(&$vars, $hook) {
  ...
  if (arg(0) == 'taxonomy' && arg(1) == 'term' ){
    ...
    $vars['theme_hook_suggestions'][0] = 'page__taxonomy__vocabulary__' . $term->vid;
	//echo "<pre>";
	//print_r($vars);
	//die();
  }
...
function porto_preprocess_html(&$vars){
  ...
  $meta_keywords = array(
    ...
    '#attributes' => array(
      'name' => 'keywords',
      'content' =>  'Java/JEE, Python, Android, Objective-C, C#, Swift, AngularJS, Django, Spring WebFlow, WordPress, Drupal, Ruby on Rails',
    )
  );
  ...
  $meta_description = array(
    ...
    '#attributes' => array(
      'name' => 'description',
      'content' =>  'Our main domain of interest is Java/JEE, Python,Ruby on Rails, .NET technologies with Android and iOS, which we use in cooperation with various frameworks to create scalable solutions. We offer a comprehensive Project Outsourcing solution, detailed design of the whole system and implementation of the needed features in application, software and web development, quality assurance, cloud infrastructure and hosting services.',
    )
  );
  ...
  $custom_css = array(
    '#tag' => 'link',
    '#attributes' => array(
      'href' => ''.$parent_root.'/css/custom.css',
      'rel' => 'stylesheet',
      'type' => 'text/css',
      'media' => 'screen',
    ),
  ...
  drupal_add_html_head( $custom_css, 'custom_css');
...
function porto_webform_mail_headers($variables) {
  $headers = array(
    'X-Mailer' => 'Drupal Webform (PHP/' . phpversion() . ')',
  );

  $headers['cc'] = 'cv@soldevelo.com';
