 ...
 <?php print render($title_prefix); ?>
  ...
  <?php if (render($content['field_image'])) : ?> 
	  ...
	  <?php if ($image_slide == 'true'): ?>
		  <div class="post-image span4" style="margin-right:60px; margin-left: 0px; margin-top: 20px;">
			  <div class="flexslider flexslider-center-mobile flexslider-simple"  style="height:200px;" data-plugin-options='{"animation":"slide", "animationLoop": true, "maxVisibleItems": 1}'>
			    <ul class="slides">
					  <?php if (render($content['field_image'])) : ?>
		...
		<?php if ($image_slide == 'false'): ?>
		  <div class="single-post-image span4" style="margin-right:60px; margin-left: 0px; margin-top: 20px;">
		    <?php print render($content['field_image']); ?>
		  </div>  
		<?php endif; ?>
  ...
  <?php endif; ?>
	...
	<div class="post-content">
	  ...
	  <div class="article_content"<?php print $content_attributes; ?> style="margin-top:20px;">
	    <?php
  ...
  <?php endif; ?>
  <!-- Script that makes photos clickable -->
<script>
	var forEach = Array.prototype.forEach;
	var imgTable = jQuery(".field-image-article");
	forEach.call(imgTable, function(child) {
		jQuery("img",child).wrap("<a class='lightbox' data-plugin-options=\"{&quot;type&quot;:&quot;image&quot;}\"" +" href="+jQuery("img",child).prop("src")+"></a>");
	});
</script>
